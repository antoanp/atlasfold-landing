...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const path = paths.services.internetMarketing;
...
export default async function InternetMarketingServicePage({ params }: Props) {
  ...
  const serviceSchema = {
    ...
    url: `${baseUrl}/${locale}/${paths.services.internetMarketing}`,
  };
      ...
      <main className="min-h-screen bg-page">
        <section className="py-16 lg:py-24">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <LeadCtaSection namespace="internetMarketingPage" className="mt-14" />
